...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_RQFP4] = {
        .type_name                = "rqfp4",
        .blck_size                = QK_RQFP4,
        .type_size                = sizeof(block_rqfp4),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_rqfp4,
        .from_float_ref           = (ggml_from_float_t)quantize_row_rqfp4_ref,
    },
    [GGML_TYPE_Q2_K] = {
        .type_name                = "q2_K",
        .blck_size                = QK_K,
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_RQFP4:   result = quantize_rqfp4  (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
